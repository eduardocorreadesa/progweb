...
public class CadastrarPessoaFisica extends javax.swing.JFrame {
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        String dataNascimento = inputDataNascimento.getText();
        String agencia = inputAgencia.getText();
        String conta = inputAgencia.getText();
 //       String sexo = inputSexo.getSelectedItem().toString();
 //       String estadoCivil = inputEstadoCivil.getSelectedItem().toString();
        
        PessoaFisica pessoaFisica = new PessoaFisica();
        
            pessoaFisica.createPessoaFisica(nome, cpf, dataNascimento, null, null, conta, agencia);
