 ...
 */
public class SaldoPessoaFisicaPessoaJuridica extends javax.swing.JFrame {

	/**
	 * Creates new form SaldoPessoaFisicaPessoaJuridica
	 */
	...
	private void initComponents() {
		...
		jLabel1.setText("Saldo Pessoa Fisica e Pessoa Juridica");
	...
	private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
		try {
			...
			DefaultTableModel model = (DefaultTableModel) tabelaSaldo.getModel();
			model.setNumRows(0); 
			...
			for (PessoaFisica c : cnts) {              
				...
				model.addRow(new Object[]{c.getNome(), c.getSaldo(), c.getLimite()});           
			} 
			...
			for (PessoaJuridica c : juridica) {              
				//aqui vc colaca os valores que vc quer capturar da lista de contatos
				model.addRow(new Object[]{c.getNomeFantasia(), c.getSaldo(), c.getLimite()});           
			}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(SaldoPessoaFisicaPessoaJuridica.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new SaldoPessoaFisicaPessoaJuridica().setVisible(true);
			}
		});
	}
